...
def print_question(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        ...
        middle = "between"
    return print(f"You rolled a {die_1_value} and a {die_2_value}... What is the {question_type} {middle} {die_1_value} and {die_2_value}?")
...
def is_correct_answer(die_1_value, die_2_value, question_type, given_answer):
    ...
    # complete this function below here
    if question_type == "sum":
        if given_answer == die_1_value + die_2_value:
            return True
        else:
            return False
    else:
        if given_answer == abs(die_2_value - die_1_value):
            return True
        else:
            return False
...
def print_correct_answer(die_1_value, die_2_value, question_type):
    ...
    if question_type == "sum":
        ...
        print(f"No! The diffence between {die_2_value} and {die_1_value} is {abs(die_2_value - die_1_value)}")
